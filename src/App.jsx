...
const Hero = () => {
  return (
    <section id="home" className="container py-5 mt-5 min-vh-100 d-flex align-items-center">
      <div className="row w-100 align-items-center flex-column-reverse flex-lg-row">
        <div className="col-lg-7 text-center text-lg-start mt-5 mt-lg-0">
          ...
          <h1 className="display-4 fw-bold text-white mb-0">
            Hi, I&apos;m <span className="display-3 text-accent d-block d-lg-inline">Humayun</span>
          </h1>
          ...
          <p className="lead text-secondary mb-4 hero-lead-width mx-auto mx-lg-0">
            I enjoy turning ideas into <strong className="text-light fw-semibold">maintainable Laravel</strong>{' '}
            features and <strong className="text-light fw-semibold">clear, reliable UI flows</strong>—always
            learning from real builds and documentation.
          </p>

          <div className="mb-4">
            <div className="d-flex flex-wrap gap-2 justify-content-center justify-content-lg-start">
              {HERO_BADGES.map((skill) => (
                <span key={skill} className="badge bg-secondary rounded-pill py-2 px-3 fw-medium">
                  {skill}
                </span>
              ))}
            </div>
        ...
        <div className="row align-items-center g-4">
          <div className="col-lg-6">
            <div className="fs-5 text-secondary lh-lg mb-0 text-center text-lg-start">
              <p className="mb-3">
                I work mostly with <strong className="text-light fw-semibold">PHP and Laravel</strong> to
                build web apps and handle backend work. I&apos;m learning{' '}
                <strong className="text-light fw-semibold">JavaScript and React</strong> so I can grow into
                full stack development over time.
              </p>
              <p className="mb-0">
                I learn by building small projects and reading the official docs. I&apos;m{' '}
                <strong className="text-light fw-semibold">open to junior roles and internships</strong>—happy
                to learn on the job and help the team wherever I can.
              </p>
            </div>
          </div>
            ...
            <div className="row g-3">
              <div className="col-sm-4">
                <div className="glass-card text-center p-3">
                  ...
                  <p className="text-secondary small mb-0">Portfolio projects</p>
                </div>
              </div>
              <div className="col-sm-4">
                <div className="glass-card text-center p-3">
              ...
              <div className="col-sm-4">
                <div className="glass-card text-center p-3">
                  ...
                  <p className="text-secondary small mb-0">Tools &amp; topics</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {Object.entries(SKILLS).map(([category, data]) => (
          <div className="col-md-4" key={category}>
            <div className="glass-card d-flex flex-column align-items-center text-center">
              <i className={`${data.icon} fs-1 ${data.colorClass} mb-3`} aria-hidden />
              <h3 className="fw-bold text-white mb-4 text-capitalize h4">{category}</h3>
              <div className="d-flex flex-wrap justify-content-center gap-2">
                {data.list.map((skill) => (
                  <span key={skill} className={`badge badge-custom-pill ${data.badgesClass}`}>
                    {skill}
                  </span>
                ))}
              </div>
...
const ProjectsSection = () => {
  return (
    <section id="projects" className="py-5 mt-4" style={{ backgroundColor: 'transparent' }}>
              ...
              <div className="glass-card project-card d-flex flex-column h-100">
                ...
                <div className="mb-4 d-flex flex-wrap gap-2">
                  {project.tech.map((t, idx) => (
                    <span key={`${project.id}-${t}-${idx}`} className="badge badge-custom-pill badge-purple">
                      {t}
                    </span>
                  ))}
                </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="text-decoration-underline github-link-text">View on GitHub</span>
                  </a>
                </div>
              </div>
            </div>
    ...
    <section id="contact" className="container py-5 mt-4">
      <div className="text-center mx-auto mb-5 text-container-narrow">
        ...
        <p className="text-secondary fs-5 mb-0">
          I&apos;m looking for a <span className="text-light fw-medium">junior developer role</span> focused
          on PHP, Laravel, or full stack work—and I&apos;m open to the right internship if it&apos;s a strong
          learning fit. If you&apos;d like to talk about a role, a project, or mentorship, reach out through
          ...
          <div key={contact.id} className="col-sm-6 col-lg-3">
            ...
            >
              <div className="glass-card contact-card text-center d-flex flex-column align-items-center justify-content-center h-100 w-100 p-4 border-0">
                <i className={`${contact.icon} fs-1 text-accent mb-3`} aria-hidden />
                <h3 className="fw-bold text-light mb-1 h5">{contact.platform}</h3>
...
const Footer = () => {
  return (
    <footer className="py-4 border-top border-secondary border-opacity-25" style={{ backgroundColor: '#050508' }}>
